      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight text-balance">
           Nos Caravanes de l'Espoir
          </h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed text-pretty">
            Depuis plusieurs années, LES LÉVITES INTER sillonne la Côte d'Ivoire à travers ses <b>caravanes médicales</b> :  
            des tournées humanitaires offrant soins, dépistages, dons et accompagnement spirituel aux populations les plus éloignées.
          </p>
        </div>
      </div>
