...
export function CallToActionCaravane() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-12 leading-relaxed text-primary-foreground/90 text-pretty">
              Vous pouvez participer, parrainer ou contribuer à rendre cette mission possible.
              Ensemble, allons plus loin pour sauver des vies.
            </p>
          </div>
